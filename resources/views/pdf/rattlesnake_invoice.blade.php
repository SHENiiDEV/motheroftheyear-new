...
<head>
    <meta charset="utf-8">
    <title>Invoice — Rattlesnake Group Limited</title>
    <style>
        body {
...
<body>
    ...
    <table class="header-table">
        <tr>
            <td style="vertical-align: middle;">
                ...
                <div class="brand-subtitle">Software Engineering & Digital Design Studio</div>
            </td>
    ...
    <table class="details-table">
        <tr>
            ...
            <td class="details-box">
                ...
                <div style="margin-top: 6px;">Reference: <strong>INV-RSG-2026-0491</strong></div>
                <div>Date: <strong>Sep 07, 2026</strong></div>
            </td>
        </tr>
    </table>
    ...
    <table class="items-table">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="item-desc">UI/UX Design, Visual Identity & Graphic Assets</div>
                    <div class="item-subtext">Complete web UI design system, mobile drawer menu UX, responsive layout architecture, typography calibration, and brand identity suite.</div>
                </td>
            ...
            <tr>
                <td>
                    <div class="item-desc">Full-Stack Web Development & Platform Architecture</div>
                    <div class="item-subtext">Turnkey Laravel 12 & Inertia.js platform engineering, B2B DomPDF invoice engine, Telegram Bot webhook integration, multi-currency wallet system, and performance optimization.</div>
                </td>
                <td style="text-align: center; font-weight: bold;">1</td>
    ...
    <table class="summary-table">
        <tr>
            <td style="color: #64748b;">Design Subtotal:</td>
            <td style="text-align: right; font-weight: bold;">€10,000.00</td>
        </tr>
        <tr>
            <td style="color: #64748b;">Development Subtotal:</td>
            <td style="text-align: right; font-weight: bold;">€12,000.00</td>
        </tr>
        <tr>
            <td style="color: #64748b;">Subtotal:</td>
            <td style="text-align: right; font-weight: bold;">€22,000.00</td>
        </tr>
        <tr>
        ...
        <tr class="total-row">
            <td>Total Paid:</td>
            <td style="text-align: right;">€22,000.00 EUR</td>
        </tr>
    </table>
